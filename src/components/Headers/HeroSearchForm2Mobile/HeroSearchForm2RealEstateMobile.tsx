...
import RealestateMobileBuySearchForm from "./real-estate-search-form/RealestateMobileBuySearchForm";
import RealestateMobileRentSearchForm from "./real-estate-search-form/RealestateMobileRentSearchForm";
    ...
    return (
      ...
      >
        ...
        <div className="ml-3 flex-1 text-left overflow-hidden">
          <span className="block font-medium text-sm">Click here to search for properties </span>
            ...
            <div className="flex h-full">
              ...
              >
                <Dialog.Panel className="relative h-full overflow-hidden flex-1 flex flex-col justify-between ">
                  {showDialog && (
                    <Tab.Group onChange={setSelectedTabIndex} manual>
                          ...
                          <Tab key={index} as={Fragment}>
                            {({ selected }) => (
                              <div
                                ...
                                onClick={() =>
                                  dispatch(setSearchActiveTab(item))
                                }
                              >
                                <div
                      ...
                      <div className="flex-1 pt-3 px-1.5 sm:px-4 flex overflow-hidden">
                        <Tab.Panels className="flex-1 overflow-y-auto hiddenScrollbar py-4">
                          ...
                          <Tab.Panel>
                            <div className="transition-opacity animate-[myblur_0.4s_ease-in-out]">
                              <RealestateMobileRentSearchForm
                                closeModal={closeModal}
                              />
                            </div>
                          </Tab.Panel>
